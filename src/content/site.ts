  ...
  projects: {
    ...
    items: [
      ...
      },
      {
        ...
        description: 'Ofertas de viajes, vuelos, empleos y servicios recolectadas automáticamente por un flujo de n8n. Filtra por categoría, precio y fechas y ve directo a reservar.',
        image: '/images/apps/offers_dashboard.png',
        tags: ['n8n', 'Supabase', 'Automatización', 'Datos'],
      },
    ],
  },

  offersDashboard: {
    intro: 'Estas ofertas se actualizan solas: un flujo de n8n las recolecta, las guarda en nuestra base de datos y esta vista simplemente las muestra. No necesitas configurar ninguna API Key.',
    stats: {
      total: 'Ofertas disponibles',
      showing: 'Coinciden con tus filtros',
      lastUpdate: 'Última actualización',
      never: 'Sin datos aún',
    },
    filters: {
      title: 'Filtrar ofertas',
      search: 'Buscar por título, origen o destino',
      category: 'Categoría',
    ...
    states: {
      ...
      loadingText: 'Consultando la base de datos actualizada por n8n...',
      emptyTitle: 'Todavía no hay ofertas',
      emptyText: 'El flujo de automatización aún no ha guardado ninguna oferta. Vuelve más tarde o ejecuta el workflow de n8n.',
      noResultsTitle: 'Sin resultados para estos filtros',
      noResultsText: 'Prueba ampliando el rango de precio, quitando las fechas o eligiendo otra categoría.',
