  ...
  projects: {
    ...
    items: [
      ...
      },
      {
        ...
        title: 'Image Studio',
        category: 'Diseño',
        description: 'Genera imágenes de propósito general con IA, usando múltiples activos (persona + logo) y ratios personalizados.',
        image: '/images/apps/image_studio.png',
        tags: ['Imágenes', 'IA', 'Edición'],
      },
      {
        id: 'digital-clones',
        title: 'Digital Clones',
        category: 'Video',
        description: 'Crea clones digitales y avatares de IA parlantes a partir de una fotografía. Genera múltiples variantes y configura voz, narración y copy para redes.',
        image: '/images/apps/digital_clones.png',
        tags: ['Video', 'Avatares', 'Voces'],
      },
      {
        id: 'form-assistant',
        title: 'Form Assistant',
        category: 'Productividad',
        description: 'Completa formularios con ayuda de IA. Un chatbot te guía paso a paso mientras editas el formulario en tiempo real.',
        image: '/images/apps/form_assistant.png',
        tags: ['Chatbot', 'Automatización'],
      },
      {
        id: 'encuestas-ia',
        title: 'Encuestas IA',
        category: 'Productividad',
        description: 'Crea encuestas y formularios personalizados en minutos. Analiza respuestas con inteligencia artificial y visualiza estadísticas en tiempo real.',
        image: '/images/apps/encuestas_ia.png',
        tags: ['Datos', 'Analítica', 'Surveys'],
      },
      {
        id: 'eduslide',
        title: 'EduSlide',
        category: 'Educación',
        description: 'Crea presentaciones educativas con avatares de IA. Genera imágenes profesionales, narración con voz y talking heads animados.',
        image: '/images/apps/eduslide.png',
        tags: ['Presentaciones', 'Educación', 'Voz'],
      },
    ],
  },
